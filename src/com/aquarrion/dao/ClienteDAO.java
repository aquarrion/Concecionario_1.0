...
public class ClienteDAO {
    ...
    public ClienteDAO (){
        connetion = ConectorBD.getConnection();
    }

    public void addCliente(Cliente cliente){
        try{
            PreparedStatement preparedStatement = connetion.prepareStatement(
    ...
    public List<Cliente> getALLClientes(){
        ...
        try{
            ...
            System.out.println("Error al listar los cliente: " + e.getMessage());
        }
